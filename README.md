GOOGLE CLOUD PLATFORM 3 TIER APPLICATIONPrerequisities:
...
1. Section where you can define the number of instances running by editing the variables file under maximum or minimum
 autoscaling_policy {
...
1. Creating a machine template so the autoscaling knows what type of machine to work with.
...
1. Also add your google_compute_instance_group_manager, google_compute_target_pool, and google_compute_firewall resource in asg.tf file as well for handling firewall and targets groups. creating a target pool:
...
1. Go Gcloud and check if resources are created properly
2. Use public IP for the instance and see if you are able to load the wordpress
3. Use **mysql -u username -h yourip -p db_name_here ** command and provide your db password to connect from your VM machine to your database instance
And your wordpress should be UP and RUNNING!!!![image](https://github.com/siyabendboral/gcp_team3/assets/148381335/97af7e72-48ec-45d4-92de-aba0a1450bc3)
